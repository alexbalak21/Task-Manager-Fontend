...
import EditUserProfile from "../../UserProfile/partials/EditUserProfile";
...
export default function SidebarUserProfile({ name, email, profile_image }: SidebarUserProfileProps) {
	...
	return (
		<div className="border-b border-gray-200 px-6 pb-4 pt-3 text-center">
			...
			{showEditModal && <EditUserProfile isOpen={showEditModal} onClose={() => setShowEditModal(false)} />}
		</div>
	);
}
